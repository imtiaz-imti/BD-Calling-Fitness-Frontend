...
export const getUserDetails = (userID)=> async (dispatch)=>{
    try {
        const {data} = await axios.get(`https://bd-calling-fitness.onrender.com/api/v1/user/${userID}`)
...
export const requestTrainerList = (userID)=> async (dispatch)=>{
    try {
        const {data} = await axios.get(`https://bd-calling-fitness.onrender.com/api/v1/request/trainer/list/${userID}`)
...
export const availableTrainerList = (userID,s,e,t)=> async (dispatch)=>{
    try {
        const {data} = await axios.get(`https://bd-calling-fitness.onrender.com/api/v1/available/trainer/list/${userID}/${s}/${e}/${t}`)
        // console.log(data)
...
export const bookTrainerList = (userID)=> async (dispatch)=>{
    try {
        const data = await axios.get('https://bd-calling-fitness.onrender.com/api/v1/book/trainer/list')
...
export const allTrainerList = (userID)=> async (dispatch)=>{
    try {
        const {data} = await axios.get(`https://bd-calling-fitness.onrender.com/api/v1/all/trainer/list/${userID}`)
...
export const requestAdminList = (userID)=> async (dispatch)=>{
    try {
        const {data} = await axios.get(`https://bd-calling-fitness.onrender.com/api/v1/request/admin/list/${userID}`)
