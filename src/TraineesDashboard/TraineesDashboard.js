   ...
   return (
     <div className='admindash'>
        ...
        <div className='admindash2'>
           <Link to="/book/trainer/5.30/7.30/AM"><Schedule props={{start:'5.30',end:'7.30',time:'AM'}}/></Link>
           <Link to="/book/trainer/7.30/9.30/AM"><Schedule props={{start:'7.30',end:'9.30',time:'AM'}}/></Link>
           <Link to="/book/trainer/9.30/11.30/PM"><Schedule props={{start:'9.30',end:'11.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/11.30/1.30/PM"><Schedule props={{start:'11.30',end:'1.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/1.30/3.30/PM"><Schedule props={{start:'1.30',end:'3.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/3.30/5.30/PM"><Schedule props={{start:'3.30',end:'5.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/5.30/7.30/PM"><Schedule props={{start:'5.30',end:'7.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/7.30/9.30/PM"><Schedule props={{start:'7.30',end:'9.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/9.30/11.30/PM"><Schedule props={{start:'9.30',end:'11.30',time:'PM'}}/></Link>
           <Link to="/book/trainer/11.30/1.30/AM"><Schedule props={{start:'11.30',end:'1.30',time:'AM'}}/></Link>
        </div>
